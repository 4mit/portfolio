              ...
              <div className="flex-grow-1">
                ...
                <div>
                  <ul>
                    ...
                    <li>
                      Architected modular front end (Custom Auth-guard, Lazy
                      modules , interceptors, Reusable modules and component ,
                      central service to handle overall network request,
                      reusable pipes, web worker , rxjs , ngrx)
                    </li>
                    <li>
                      Optimizing multiple network call for smooth User
                      Experience created a central API system for product
                    </li>
                    <li>
                      Improved app performance and enhanced initial load from
                      2min to 30sec.
                    </li>
                    <li>
                      {" "}
              ...
              <div className="flex-grow-1">
                ...
                <div>
                  <ul>
                    ...
                    <li>
                      API integration, and Core functionality Development for
                      the product.Worked with Material, Bootstrap, and
                      Visualization UI libraries i.e. plotly, d3, high-charts
                    </li>
                    <li>
            ...
            <div className="d-flex flex-column flex-md-row justify-content-between mb-5">
              <div className="flex-grow-1">
                ...
                <div>
                  <ul>
                    <li>
                      Closely Worked with Data science team to Design and
                      Implement various Visualization i.e Confusion Matrix ,
                      Time series Charts
                    </li>
